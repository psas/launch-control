...
public interface CanBusIDs {
	...
	public static final int IMU_MODE_SAFE = 0x0020; /* from imu/imu_exports */
	public static final int IMU_MODE_ARMED = 0x002f; /* from imu/imu_exports */
	public static final int IMU_COMMAND_SLEEP = 0x0022; /* from imu/imu_exports */
	public static final int IMU_COMMAND_WAKE = 0x0024; /* from imu/imu_exports */
	public static final int IMU_COMMAND_RESET = 0x0028; /* from imu/imu_exports */
	public static final int IMU_COMMAND = 0x0000; /* from imu/imu_exports */
	...
	public static final int REC_MODE_SAFE = 0x0030; /* from recovery/recovery_exports */
	public static final int REC_MODE_ARMED_2M = 0x0033; /* from recovery/recovery_exports */
	public static final int REC_MODE_ABORT = 0x0037; /* from recovery/recovery_exports */
	public static final int REC_MODE_ARMED = 0x003f; /* from recovery/recovery_exports */
	public static final int REC_COMMAND_SLEEP = 0x0032; /* from recovery/recovery_exports */
	public static final int REC_COMMAND_WAKE = 0x0034; /* from recovery/recovery_exports */
	public static final int REC_COMMAND_RESET = 0x0038; /* from recovery/recovery_exports */
	...
	public static final int REC_COMMAND = 0x0060; /* from recovery/recovery_exports */
	...
	public static final int REC_HVSUPP = 0x00e0; /* from recovery/recovery_exports */
	public static final int REC_NODE_COMMAND = 0x0861; /* from recovery/recovery_exports */
	public static final int REC_REPORT_ERROR = 0x0983; /* from recovery/recovery_exports */
	...
	public static final int REC_REPORT_MODE = 0x0941; /* from recovery/recovery_exports */
	...
	public static final int REC_GET_HVSUPP = 0x0bf2; /* from recovery/recovery_exports */
	public static final int REC_REPORT_HVSUPP = 0x09e2; /* from recovery/recovery_exports */
	...
	public static final int REC_GET_BATTERY = 0x0bd0; /* from recovery/recovery_exports */
	public static final int REC_REPORT_BATTERY = 0x09c6; /* from recovery/recovery_exports */
}
